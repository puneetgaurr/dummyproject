...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { address: @information.address, name: @information.name, pincode: @information.pincode }
    end
  ...
  test "should update information" do
    patch :update, id: @information, information: { address: @information.address, name: @information.name, pincode: @information.pincode }
    assert_redirected_to information_path(assigns(:information))
  end
